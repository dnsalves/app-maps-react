...
import { getMap, changeDescription } from './mapsAction'
...
class Maps extends Component {
    ...
    render() {        
        const { getMap, changeDescription, address, location } = this.props
            ...
            <div className="container">
                <div className="card px-4 py-3 mt-5 mb-2">
                    ...
                    <div className="card-body">
                        <div className="row">
                            <LabelAndInput change={changeDescription} name="address" label="Informe um endereço" cols="10 10 10 10" placeholder="Ex.: Avenida paulista, 1000" />
...
const mapDispatchToProps = dispatch => bindActionCreators({ getMap, changeDescription }, dispatch)
